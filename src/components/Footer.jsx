...
const Footer = () => {
  return (
    <>
      <footer>
        <div className="lg:w-[70%] flex flex-col items-center justify-center mx-auto  text-center ">
          <div>
            <img
              src="https://cdn.shopify.com/s/files/1/0612/2477/9832/files/logo-small.png?v=1677089352&width=1100"
              className="w-[4rem]"
              alt="logo"
            />
          </div>
          ...
          <p className="text-[18px]text-gray-600 leading-7 p-4 mb-4">
        ...
        <div className="mx-12 flex items-center justify-between">
          ...
          <div class="">
            <span className="invisible">Payment methods</span>
